...
function reduce(obj) {
    ...
    // Subtotal
    var singelSumElement = obj.parentElement.parentElement.children[4];
...
function singleSubTotal(obj) {
    var price = obj.parentElement.children[2].innerHTML;
    var count = obj.parentElement.children[3].children[1].value;
...
function addToCart(obj) {
    ...
    if (result != "-1") {
        ...
        td4.innerHTML = '<button οnclick="reduce(this)">-</button>&nbsp;'
        ...
        td6.innerHTML = '<a href="#" class="delete" οnclick="deleteChild(this)"> Eliminar </a>';
